  ...
  return (
    <div className="p-6 lg:p-8">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">AI Resume Feedback</h1>
          <p className="text-gray-600">Get personalized feedback powered by artificial intelligence</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="card">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-lg font-semibold text-gray-900">Job Role or Query</h2>
            </div>
          ...
          {feedback && (
            <div className="card">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={downloadFeedbackPDF} className="btn-success flex items-center">
              ...
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">{HighlightedText(feedback)}</div>
            </div>
          )}
        </div>
      </div>
    ...
    return parts
      .map((part, i) => {
        ...
        if (isHeading && part.length < 50) {
          return (
            <span key={i} className="font-semibold text-blue-700 block mt-3 mb-1">
              {part}
            </span>
          )
        }
      ...
      {sections.map((section, index) => {
        ...
        return (
          <div key={index} className="border-l-4 border-blue-200 pl-4">
            ...
            <div className="text-gray-700 leading-relaxed">{renderHighlighted(content)}</div>
          </div>
        )
      })}
    </div>
