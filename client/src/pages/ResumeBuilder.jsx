...
const DialogContent = ({ children }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white p-6 rounded-md shadow-lg relative min-w-[300px]">
        <button
...
const SheetContent = ({ children }) => {
  ...
  return (
    <div className="fixed inset-0 z-40 flex">
      <div className="w-72 bg-white p-4 h-full shadow-md z-50 relative">
        <button
          className="absolute top-2 right-2 text-gray-500 hover:text-black"
          onClick={() => setOpen(false)}
        >
...
const Switch = ({ checked, onChange }) => (
  <label className="inline-flex items-center cursor-pointer">
    <input
      ...
      className="hidden"
    />
    <span className="w-10 h-6 flex items-center bg-gray-300 rounded-full p-1">
      <span
        ...
        <View style={pdfStyles.section}>
          ...
          {data.projects.map((proj) => (
            <View key={proj.id} style={pdfStyles.experienceItem}>
              ...
              <Text style={pdfStyles.expDescription}>{proj.description}</Text>
            </View>
          ))}
        </View>
      )}
...
export default Resume;`;
  ...
  const moveExperienceItem = (id, direction) => {
  ...
  const moveEducationItem = (id, direction) => {
  ...
  const moveProjectItem = (id, direction) => {
    setResumeData((prev) => {
